...
const Register = () => {
    ...
    return (
        ...
        <h3 className="register-header">Gamer Network</h3>
        ...
        placeholder={alert.fullname ? `${alert.fullname}`: 'Enter your Full Name'}
        ...
        name="email"
        onChange={handleChange}
        placeholder={alert.email ? `${alert.email}`: 'Enter your Email Address'}
       ...
       ></input>
        ...
        <input
        className="register-dataformpass"
        type={showcfpass ? "type" : "confirm password"}
        placeholder={alert.confirmPassword ? `${alert.confirmPassword}`: 'Re-enter your Password'}
